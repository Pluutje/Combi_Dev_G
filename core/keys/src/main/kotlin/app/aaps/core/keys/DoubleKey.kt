...
enum class DoubleKey(
    ...
    LKh_boost_smb("LKh_boost_smb", 0.0,0.0,5.0),
    MKh_boost_smb("MKh_boost_smb", 0.0,0.0,5.0),
    HKh_boost_smb("HKh_boost_smb", 0.0,0.0,5.0),
    standaard_TDD("standaard_TDD", 25.0,10.0,75.0),
    min_basaal("min_basaal", 0.2,0.1,1.0),
    max_basaal("max_basaal", 0.7,0.5,2.0),
