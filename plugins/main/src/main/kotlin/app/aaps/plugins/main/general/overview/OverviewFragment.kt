...
class OverviewFragment : DaggerFragment(), View.OnClickListener, OnLongClickListener {
    ...
    private fun onClickQuickWizard() {
        ...
        if (quickWizardEntry != null && actualBg != null && profile != null) {
            binding.buttonsLayout.quickWizardButton.visibility = VISIBLE
    ...
    private fun processButtonsVisibility() {
        ...
        runOnUiThread {
            ...
            if (showAcceptButton && pump.isInitialized() && !pump.isSuspended() && (loop as PluginBase).isEnabled()) {
                binding.buttonsLayout.acceptTempButton.visibility = VISIBLE
                if (lastRun != null) {
                    ...
                    if (event.isEnabled && event.canRun()) {
                        context?.let { context ->
                            SingleClickButton(context, null, app.aaps.core.ui.R.attr.customBtnStyle).also {
                                ...
                                it.setTextColor(Color.parseColor("#000000"))  // #353835  #15e61b  #000000
    ...
    private fun processAps() {
        ...
        runOnUiThread {
            ...
            if (config.APS && pump.pumpDescription.isTempBasalCapable) {
                binding.infoLayout.apsMode.visibility = VISIBLE
                ...
                when {
                    (loop as PluginBase).isEnabled() && loop.isSuperBolus                       -> {
                        ...
                        binding.infoLayout.apsModeText.visibility = VISIBLE
                    }
                ...
                binding.infoLayout.apsModeText.visibility = View.GONE
                binding.infoLayout.timeLayout.visibility = VISIBLE
            }
    ...
    fun updateBg() {
        ...
        runOnUiThread {
            ...
            if (qualityIcon != 0) {
                binding.infoLayout.bgQuality.visibility = VISIBLE
    ...
    private fun updateSensitivity() {
        ...
        if (variableSens != isfMgdl && variableSens != 0.0 && isfMgdl != null) {
            ...
            text += String.format(
                //        Locale.getDefault(), "%1$.1f→%2$.1f (%3$.1f)",  Thank you
              //  Locale.getDefault(), "%1$.1f→%2$.1f",
                Locale.getDefault(), "→%1$.1f",
