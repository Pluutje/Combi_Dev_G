...
class DetermineBasalDynSMB @Inject constructor(
    ...
    fun ActExtraIns(profile: OapsProfile):Extra_Insuline {
...
// Controleer welk tijdsinterval van toepassing is en zet de booleans
        ...
        log_DagNacht = log_DagNacht + " ● Tijd: " + uurVanDag.toString() + ":" + minuutTxt + " → Deel v/d Dag = " + DeelvanDag + "\n"
...
// Einde IOB - Bg code
        ...
        var overall_cf = Bg_ISF_cf * Persistent_ISF_cf * uam_boost_cf * extraIns_cf * sensitivityRatio * ResistentieCfEff * stap_cf *  Automation_Note_cf * hypo_corr_cf * bg_iob_cf
